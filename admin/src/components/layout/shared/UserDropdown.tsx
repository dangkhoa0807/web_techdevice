...
const UserDropdown: React.FC<Props> = props => {
  ...
  const handleUserLogout = async () => {
    try {
      const reponsive = await axios.post(`${process.env.NEXT_PUBLIC_API_AUTH}/logout`, {}, { withCredentials: true })
              ...
              <ClickAwayListener onClickAway={e => handleDropdownClose(e as MouseEvent | TouchEvent)}>
                <MenuList>
                  <div className='flex items-center plb-2 pli-6 gap-2' tabIndex={-1}>
                    <Avatar alt='John Doe' src={`${process.env.NEXT_PUBLIC_APP_PUBLIC}/avatar/${user?.avatar}`} />
